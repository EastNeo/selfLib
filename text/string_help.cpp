...
std::map<std::string, std::string> StringHelp::StringSplit(const std::string &src, const std::string &delimiter)
{
...
{
    auto is_str = [&](const std::string &str) { return StringHelp::compare(value, str, true) == 0; };
